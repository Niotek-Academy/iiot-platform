...
type CreateMachineRequest struct {
	...
	ControlAddress *string `json:"control_address" binding:"omitempty,max=100"` // OPC UA NodeID / Modbus register for this machine's stop line
}
...
type UpdateMachineRequest struct {
	...
	Status         *string `json:"status" binding:"omitempty,oneof=OPERATIONAL WARNING CRITICAL STOPPED"`
	ControlAddress *string `json:"control_address" binding:"omitempty,max=100"`
}
